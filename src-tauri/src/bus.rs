...
pub async fn handle_command(app: AppHandle, command: Command) {
    match command {
        ...
        Command::CoverBase => subsystems::playback::cover_base(&app),
        Command::YtdlpCheck => subsystems::playback::check_ytdlp(&app),
        ...
        Command::UpdateCheck => subsystems::update::check(&app),
