// Ported verbatim from YTMLite's src/lib/innertube/explore.ts.
...
// Identical ids work for anonymous and signed-in users.
const BROWSE_ID = {
...
// the navigation tile, `params` is the opaque token from the same tile
// that selects which category.
